...
var ProposalListComponent = /** @class */ (function () {
    function ProposalListComponent() {
        ...
        this.proposalTwo = new proposal_1.Proposal(16, 'Xyz Company', 'http://portfolio.jordanhudgens.com', 'Ruby on Rails', 150, 120, 15, 'jordan@devcamp.com');
        this.proposalThree = new proposal_1.Proposal(17, 'UFH Company', 'http://portfolio.jordanhudgens.com', 'Ruby on Rails', 150, 120, 15, 'jordan@devcamp.com');
